        ...
        <div className="flex flex-col min-h-screen">
            ...
            <body className="flex flex-col min-h-screen">
                ...
                <div className="flex justify-center mb-8 md:m-0">
                    <Link href="/" >
                        <a href="#" className="flex items-center justify-center w-11 h-11 md:w-12 md:h-12 p-4 text-gray-800 rounded-full border-2 md:my-20 hover:opacity-50">
                ...
                <footer className="flex items-center justify-center my-10 text-sm font-light text-gray-800">
