...
export default function Navigation() {
    return (
        <header className="container flex flex-row items-center sm:mx-auto py-10 max-w-screen-lg px-8 text-gray-800 md:px-10">
            <Link href="/">
            ...
            <div class="sm:hidden ml-auto">
                <button type="button" class="inline-flex items-center justify-end p-2 rounded-md text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-gray-500" aria-controls="mobile-menu" aria-expanded="false">
