        ...
        <div>
            <div className={`${active ? 'hidden' : ''} container max-w-screen-lg mx-auto text-gray-800 xl:px-0 border-0`}>
                <div className="flex items-center justify-between px-10 py-7">
                    ...
                    <div className="md:hidden">
                        <div>
                            <button type="button" className={`${active ? 'text-white border-white hover:opacity-50' : 'text-gray-400 border-gray-400 hover:opacity-50'} inline-flex items-center justify-end p-2 border rounded-md focus:outline-none focus:ring-0`} onClick={handleClick}>
                                {/* Humberger icon */}
            ...
            <div className={`${active ? '' : 'hidden'} fixed w-full h-full bg-black bg-opacity-80`}>
                <div className="flex items-center justify-between px-10 py-7">
                    ...
                    <div>
                        <button type="button" className={`${active ? 'text-white hover:text-gray-200 border-white hover:border-gray-200' : 'text-gray-400 hover:text-gray-500 border-gray-400 hover:border-gray-500'} inline-flex items-center justify-end p-2 border rounded-md focus:outline-none focus:ring-0`} onClick={handleClick}>
                            {/* Humberger icon */}
                            <svg className={`${active ? 'hidden' : 'block'} h-6 w-6`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
                            </svg>
                ...
                <div className="grid justify-items-center mt-9 mb-20">
                    <Link href="/">
                        <a href="#" className="px-36 py-5 my-5 text-white hover:text-white text-xl font-medium hover:bg-black block rounded-md" aria-current="page">Home</a>
                    </Link>
                    <Link href="#about">
                        <a href="#" className="px-36 py-5 my-5 text-white hover:text-white text-xl font-medium hover:bg-black block rounded-md">About</a>
                    </Link>
                    <Link href="#work">
                        <a href="#" className="px-36 py-5 my-5 text-white hover:text-white text-xl font-medium hover:bg-black block rounded-md">Work</a>
                    </Link>
                    <Link href="/">
                        <a href="#" className="px-36 py-5 my-5 text-white hover:text-white text-xl font-medium hover:bg-black block rounded-md">Contact</a>
                    </Link>
                </div>
                <div className="flex justify-center text-xl">
                    <div>
                        <a className="fab fa-twitter p-2 mr-10 bg-white rounded-3xl hover:bg-opacity-50" href="https://twitter.com/dai_twii"></a>
                        <a className="fab fa-github p-2 bg-white rounded-3xl hover:bg-opacity-50" href="https://github.com/dai-gi"></a>
                    </div>
                </div>
            </div>
        </div>
