...
export default function Navigation() {
    ...
    return (
        <div>
            <div className={`${active ? 'bg-black bg-opacity-70' : ''} relative container max-w-screen-lg mx-auto text-gray-800 xl:px-0 border-0`}>
                ...
                <div className={`${active ? '' : 'hidden'} absolute w-full bg-black bg-opacity-70`}>
                    <div className="grid justify-items-center text-3xl my-5">
                        <Link href="/">
                            <a href="#" className="px-40 py-5 text-white hover:text-white text-xl font-medium hover:bg-black block rounded-md" aria-current="page">Home</a>
                        </Link>
                        <Link href="#about">
                            <a href="#" className="px-40 py-5 text-white hover:text-white text-xl font-medium hover:bg-black block rounded-md">About</a>
                        </Link>
                        <Link href="#work">
                            <a href="#" className="px-40 py-5 text-white hover:text-white text-xl font-medium hover:bg-black block rounded-md">Work</a>
                        </Link>
                        <Link href="/">
                            <a href="#" className="px-40 py-5 text-white hover:text-white text-xl font-medium hover:bg-black block rounded-md">Contact</a>
                        </Link>
                    </div>
                    <div className="flex justify-center text-xl my-10">
                        <div>
                            <a className="fab fa-twitter p-2 mr-5 bg-white rounded-3xl hover:bg-opacity-70" href="https://twitter.com/dai_twii"></a>
