...
export default function Navigation() {
    ...
    return (
        <div className="border-b-2">
            <div className={`${active ? 'hidden' : ''} container max-w-screen-lg mx-auto text-gray-900 opacity-70 xl:px-0 border-0`}>
                <div className="flex items-center justify-between px-7 md:px-16 xl:px-7 py-4">
                    ...
                    <nav className="hidden md:block md:ml-auto">
                        ...
                        <Link href="/work">
                            <a className="font-light hover:opacity-60">Work</a>
                        </Link>
                        {/* <Link href="/contact">
                    ...
                    <div className="md:hidden">
                        <div>
                            <button type="button" className="text-gray-400 border-gray-400 hover:opacity-60 inline-flex items-center justify-end p-2 border rounded-md focus:outline-none focus:ring-0" onClick={handleClick}>
                                {/* Humberger icon */}
                                <svg className={`${active ? 'hidden transition duration-1000' : 'block'} h-6 w-6`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
                                </svg>
                                {/* X icon */}
                                <svg className={`${active ? 'block transition duration-1000' : 'hidden'} h-6 w-6`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
            ...
            <div className={`${active ? '' : 'hidden'} fixed w-full h-full bg-black bg-opacity-80`}>
                <div className="flex items-center justify-between px-7 py-7">
                    ...
                    <div>
                        <button type="button" className="text-white hover:text-gray-200 border-white hover:border-gray-200 inline-flex items-center justify-end p-2 border rounded-md focus:outline-none focus:ring-0" onClick={handleClick}>
                            {/* Humberger icon */}
                ...
                <div className="grid justify-items-center mt-9 mb-20">
                    <Link href="/">
                        <a href="#" className="px-36 py-5 my-5 text-white hover:text-white text-xl font-medium hover:bg-gray-600 block rounded-md" aria-current="page">Home</a>
                    </Link>
                    <Link href="#about">
                        <a href="#" className="px-36 py-5 my-5 text-white hover:text-white text-xl font-medium hover:bg-gray-600 block rounded-md">About</a>
                    </Link>
                    <Link href="#work">
                        <a href="#" className="px-36 py-5 my-5 text-white hover:text-white text-xl font-medium hover:bg-gray-600 block rounded-md">Work</a>
                    </Link>
                    {/* <Link href="/">
                        <a href="#" className="px-36 py-5 my-5 text-white hover:text-white text-xl font-medium hover:bg-gray-600 block rounded-md">Contact</a>
                    </Link> */}
                </div>
                <div className="flex justify-center text-xl">
                    <div>
                        <a className="fab fa-twitter p-2 mr-10 bg-white rounded-3xl hover:bg-opacity-70" href="https://twitter.com/dai_twii"></a>
                        <a className="fab fa-github p-2 bg-white rounded-3xl hover:bg-opacity-70" href="https://github.com/dai-gi"></a>
                    </div>
                </div>
            </div>
        </div>
